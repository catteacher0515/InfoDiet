...
(
    ...
    qualityScore   int                                    default 0 not null comment '内容质量分',
    qualityScoreReason varchar(1024)                      null comment '质量分说明',
    ...
    index idx_preFilterStatus_qualityScore (preFilterStatus, qualityScore)
